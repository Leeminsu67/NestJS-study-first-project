...
describe('AuthService', () => {
  ...
  describe('parseBasicToken', () => {
    ...
    it('should throw an error for Basic token format', () => {
  ...
  describe('parseBearerToken', () => {
    ...
    it('should throw a error BadRequestException invalid Bearer token format', () => {
      const rawToken = `InvalidTokenFormat`;
  ...
  describe('authenticate', () => {
    ...
    it('should throw an error for not existing user', async () => {
      ...
      expect(
        authService.authenticate('test@gmail.com', 'test'),
