...
describe('MovieService', () => {
  ...
  describe('create', () => {
    ...
    let createMovieDeatilMock: jest.SpyInstance;
    ...
    beforeEach(() => {
      ...
      createMovieDeatilMock = jest.spyOn(movieService, 'createMovieDetail');
    ...
    it('should create a movie successfully', async () => {
      ...
      createMovieDeatilMock.mockResolvedValue(movieDetailInserResult);
      ...
      expect(createMovieDeatilMock).toHaveBeenCalledWith(qr, createMovieDto);
    ...
    it('should throw NotFoundException if some genres do not exist', async () => {
      ...
      (qr.manager.findOne as any).mockResolvedValue(director);
